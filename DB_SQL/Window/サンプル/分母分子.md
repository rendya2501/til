...
SELECT
    ...
    CONCAT(
        ROW_NUMBER() OVER(PARTITION BY [ReservationNo] ORDER BY [ReservationTime]),
        '/' ,
        COUNT(1) OVER(PARTITION BY [ReservationNo]),
        CASE WHEN COUNT(*) OVER (PARTITION BY [ReservationTime]) > 1 
            THEN '+' 
            ELSE '' 
        END
    ) AS [Result]
...
SELECT DISTINCT
    [SQ].[ReservationTime],
     FIRST_VALUE([SQ].[Result]) OVER (PARTITION BY [ReservationTime] ORDER BY ReservationNo) AS [Result]
FROM(
    SELECT
        [ReservationTime],
        [ReservationNo],
...
-- ReservationTime    Result
--
-- 07:00:00.0000000    1/4
-- 07:07:00.0000000    2/4
-- 07:14:00.0000000    3/4
-- 07:21:00.0000000    4/4
-- 07:28:00.0000000    1/2
-- 07:35:00.0000000    2/2
-- 07:42:00.0000000    1/2+
-- 07:49:00.0000000    2/2
-- 07:56:00.0000000    1/1
```
...
SELECT DISTINCT
    ...
    FIRST_VALUE( 
        CONCAT(
            (SELECT ROW_NUMBER() OVER(PARTITION BY [ReservationNo] ORDER BY [ReservationTime])),
            '/',
            (SELECT COUNT(1) OVER(PARTITION BY [ReservationNo])),
            CASE WHEN (SELECT COUNT(*) OVER (PARTITION BY [ReservationTime])) > 1 
                THEN '+'
                ELSE '' 
            END
        )
    ) OVER (PARTITION BY [ReservationTime] ORDER BY ReservationNo) AS [Result]
FROM [TestReservation]

-- ReservationTime    Result
-- 07:00:00.0000000    1/1
-- 07:07:00.0000000    1/1
-- 07:14:00.0000000    1/1
-- 07:21:00.0000000    1/1
-- 07:28:00.0000000    1/1
-- 07:35:00.0000000    1/1
-- 07:42:00.0000000    1/1
-- 07:49:00.0000000    1/1
-- 07:56:00.0000000    1/1
```
...
-- ReservationTime    ReservationNo    Numerator    Denominator    Result
-- 07:00:00.0000000    RES202204160001    1    4    1/1
-- 07:07:00.0000000    RES202204160001    2    4    1/1
-- 07:14:00.0000000    RES202204160001    3    4    1/1
-- 07:21:00.0000000    RES202204160001    4    4    1/1
-- 07:28:00.0000000    RES202204160002    1    2    1/1
-- 07:35:00.0000000    RES202204160002    2    2    1/1
-- 07:42:00.0000000    RES202204160003    1    2    1/1
-- 07:42:00.0000000    RES202204160004    1    1    1/1
-- 07:49:00.0000000    RES202204160003    2    2    1/1
-- 07:56:00.0000000    RES202204160005    1    1    1/1
```
