...
[C#_非同期メソッド / async / await](https://koshinran.hateblo.jp/entry/2018/05/13/101434)  
...
言い換えると、「順序正しく実行されていれば、どのスレッドが実行しても構わない」ということになる。  
...
居林さんからAsyncをAwaitするのと、普通の同期処理は同じか？という質問を受けた。  
