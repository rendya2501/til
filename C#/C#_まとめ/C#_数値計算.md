...
Math.Truncate or Math.Floor  

Decimalでの割り算では商だけではなく、小数点以下まで出力してくれるので逆に困ってしまった。  
VB6時代ならFix関数なるものがあって、リバースエンジニアリングということもあり、なるべく同じようにしたかった。  
文献を漁ったけど、特にこれといったモノがなかったので、やっぱりMathクラスに頼ることになった。  
