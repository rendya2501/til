...
export class Environments {
  ...
  private apiUrlBase =
    'http://192.168.1.24/RN3.WEB/option/restaurant/self_order';
  ...
  private DispBarcode1 =
    'バーコードが反射して撮影しにく場合は、ホルダーを掲げて、それをスマホで撮影するようにしてください。';
  private DispThanksOrder1 =
    'ご注文を受け賜わりました。<br/>調理が終わるまでしばらくお待ちください';
