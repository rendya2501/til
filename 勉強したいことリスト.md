...
・将来的なことを見越して、GORAの接続情報は消しておいたほうがいいだろう。
→
別のリポジトリ作ってそっちに退避させた。
まだ残ってるので徹底的にやる。
場合によってはtilの作り直しも考えるか。
履歴を消すことはできないのか？
→
できそうではあるが、完璧に消えるわけではなさそうだ。
まぁ、これも訓練がてら見てみることにしよう。

ハードコーディングしてしまった場合の対処法がこれみたいだな。



sshの発行の仕方も。
今日の朝、突然出てきてイライラしただろう。
sshの生成は別に難しいことではない。
ssh-keygenコマンド叩けば普通にできる。
造った後に、作ったデータを取り出してしかるべき場所に登録するまでがsshのやり方と行っていいのではないだろうか。
分かりやすく解説してくれてるんだろうけど、俺からしたら分かりにくいので、完全にこうすればいいってやり方をまとめたいところではある。


goraのサンプルはGuzzleClinetとcallBackのサンプルがメイン。
それ以外はまぁ、特にといった感じか。
GuzzleのAPI送信とログを出力するためにbodyを頑張って取ろうと四苦八苦した記憶がある。

メールアドレスまで書かれてる始末か。
これはやばいね。
外部になんて公開できるわけがないな。

ローカルのGORAフォルダに取っておけば、まぁ困ることはないだろう。


朝の30分はとても基調であることが分かりました。
もう30分早ければもっとよかったと思います。
やっぱり起動に30分かかってしまう。
それも加味して6時に起きられれば、まぁ満足かなって思いました。
早く起きても、やることたくさんあるのでバタバタしてしまいますね。



今日である程度落ち着きそう。
まぁ、それでもやりたい勉強で消えるだろうけどね。
やっぱり4日までは無理かなー。


今のモヤモヤは勉強したいのに勉強できないのと、日常のやることが想像してたより多いことだろうか。
後は、時間配分のみなおしもやり始めた。
基本情報が終わった後のまとめたい欲はある程度おさまった。


whereはそういう条件を実行するというだけで値が確定したわけではない。
外部で実行。
