...
[このサイト](https://crieit.net/posts/UML#%E9%9B%86%E7%B4%84)で解説している合成と集約の違い。  
`管理しているもの`が所持品Zをnewしているので合成っぽいけどそのように解釈されていない。  
ここまでまとめておいて、追加で記述する必要はないが、クラス図が良く出来たので載せておく。  

``` mermaid
classDiagram
direction BT

持っているもの o--> 持たれているモノ  : - 所持品X
管理しているもの *--> 持たれているモノ  : - 所持品Z
もう1つの持っているもの o--> 持たれているモノ  : - 所持品Y
管理しているもの *--> 持っているもの : - 管理対象X
管理しているもの *--> もう1つの持っているもの  : - 管理対象Y
...
class もう1つの持っているもの {
    ...
    public もう1つの持っているもの(持たれているもの 所持品) {
        所持品Y = 所持品;
    }
}
