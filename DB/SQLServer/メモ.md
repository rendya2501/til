...
[SQLServer: int型のID値を持つテーブルをできる限り短時間でbigint型に変更する - Qiita]([SQLServer: int型のID値を持つテーブルをできる限り短時間でbigint型に変更する](https://qiita.com/maaaaaaaa/items/cdab2d91127ec8169ff1))  
