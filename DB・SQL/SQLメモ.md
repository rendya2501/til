...
MAXは0件ならNULLを返す。COALESCEは結果がNULLなら指定した値に置き換えるので本来の動作に準拠したものになるので、こちらのほうがいいのかも？  
...
これを解決するために、アレコレ考えたが、MAXでCASE文を使えることを知り、極端に大きな値以下のMAXを取得できないかやってみたら出来たのでまとめる。  
