...
## FOR XML で文字列を結合した後に前後のつなぎ文字を削除していい感じにするサンプル

2021/10/12 Tue  

`SELECT TOP 3 PlayerNo + ',' FROM SlipTable FOR xml path('')`だと`ABC202007250541,ABC202007250541,ABC202007250541,`となり、最後にコロンがついてしまうので、消したいなってことでやった。  
