...
--テーブルに対する断片化率の一覧を取得
DECLARE FragmentationList CURSOR FOR 
SELECT
...
-- カーソル処理開始
OPEN FragmentationList
FETCH NEXT FROM FragmentationList INTO @INDEX_NAME, @TABLE_NAME, @PER
    ...
    BEGIN
        ...
        FETCH NEXT FROM FragmentationList INTO @INDEX_NAME, @TABLE_NAME, @PER
    END
CLOSE FragmentationList
DEALLOCATE FragmentationList
