...
>
>多くのデータベースマイグレーションツールは、現時点と最新のスキーマ情報の差分から実行が>必要なDDL文だけを実行してくれます。  
...
>原始的な方法として思いつくのは、テキスト化できる操作やパラメーターをSubversionやGitで管理する方法です。少人数開発で小規模アプリケーションならば、なんとかなりそうです。  
