...
Bindingで指定した「**RelativeSource={RelativeSource Self}**」がthisの役割を果たす。  

```xml
<Grid>
    <TextBlock ToolTip="Tooltip Message." Text="{Binding RelativeSource={RelativeSource Self}, Path=ToolTip}" />
</Grid>
```

[XAMLでthisと同じことをする。 - Code for final](https://final.hateblo.jp/entry/2015/09/21/224910)  
